...
function writeLog($message) {
    $logFile = __DIR__ . "/importacion-violencia-".date("Y-m_d").".log"; // Ruta del log
...
$api_base = "https://datos.gov.co/resource/vuyt-mqpw.json";
$app_token  = "";  // <-- cámbialo
...
INSERT INTO delitos (
    ...
    fecha_hecho, genero, grupo_etario, cantidad, registro_hash, categoria,lat,lng
) VALUES (
    :departamento, :municipio, :codigo_dane, :armas_medios,
    :fecha_hecho, :genero, :grupo_etario, :cantidad, :registro_hash, :categoria, :lat, :lng
)
 ...
 ******************************/
 foreach ($rows as $item) {
    $item["categoria"] = "VIOLENCIA_INTRAFAMILIAR";
